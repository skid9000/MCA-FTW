	...
	<div class="ui attached segment">
		<div class="ui two column grid">
			<div class="three wide column">
				<div class="ui list">
					<a class="item" @click="getDirContent(dir)" v-for="dir in pdirs" v-bind:key="dir"> <i class="ui folder icon"></i> {{ dir }} </a>
					<a class="item" @click="setFile(file)" v-for="file in pfiles" v-bind:key="file"> <i class="ui file icon"></i> {{ file }} </a>
				</div>
			</div>
